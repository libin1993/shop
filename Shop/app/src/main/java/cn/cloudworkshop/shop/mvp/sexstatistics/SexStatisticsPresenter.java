 ...
 * Describe：
 */
public class SexStatisticsPresenter extends BasePresenterImpl<SexStatisticsContact.View> implements SexStatisticsContact.Presenter {
    @Override
        ...
        RetrofitUtils.getInstance()
                ...
                .subscribe(new RxObserver<>(new RxObserver.Callback<GuestCountBean>() {
                    ...
                    public void onSuccess(GuestCountBean guestCountBean) {
                        getView().hideLoading();
                        getView().loadSuccess(guestCountBean.getData().getGuest_gender_statistics());
                    }
