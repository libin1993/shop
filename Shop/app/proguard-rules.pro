...
-keep class [cn.cloudworkshop.shop].** {*;}
-keep class cn.cloudworkshop.shop.bean.**{*;}

-keep class cn.cloudworkshop.shop.utils.GsonUtils{*;}
...
-keep public class [cn.cloudworkshop.shop].R$*{
